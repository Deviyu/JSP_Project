...
<script>
	...
	$(function() {
		...
		$("body").on("click", ".addFile", function() {
			var tr = $("table").children().find(".file").clone();
			...
			$(tr).children().find("input:file").val("");
	...
	<div class="row">
		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div class="row">
				...
				<form id="frm" method="post" action="${pageContext.request.contextPath }/postForm" enctype="multipart/form-data">
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" value="${replyVO.post_title }" readonly>
						<input type="hidden" class="form-control" value="${param.replyTo }" name="replyTo" readonly>
						<br>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<textarea name="smarteditor" id="smarteditor" rows="10" cols="100" style="width:745px; height:412px;"></textarea>
						<br> 			
					</div>
				</div>
				<br>
